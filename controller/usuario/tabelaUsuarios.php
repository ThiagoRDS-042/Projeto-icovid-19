...
?>
    <link rel="stylesheet" href="/projeto-icovid-19/view/css/usuario/tabela.css">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="row justify-content-center" target="blank" href="../usuario/relatorio.php?exibir=<?php echo $row['usuarioID'] ?>"><img src="../imagens/relatorio.png" alt="Icone de Relatório"></a></td>
                            </tr>
                        <?php
                        endwhile;
                        ?>
